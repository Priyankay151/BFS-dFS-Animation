! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).cytoscape = t() }(this, (function() {
    ...
    var J = function(e, t, n) {
        ...
        Be = function(e, t, n) { for (var r = e.length - 1; r >= 0 && (e[r] !== t || (e.splice(r, 1), !n)); r--); },
                ...
                function x(n, r) {
                    ...
                    if ("yes" === n.pstyle("text-events").strValue && l) {
                        ...
                        if (d) {
                            var w = Math.cos(d),
                                E = Math.sin(d),
                                k = function(e, t) { return { x: (e -= u) * w - (t -= c) * E + u, y: e * E + t * w + c } },
                                C = k(g, m),
                                S = k(g, x),
                                P = k(y, m),
                                D = k(y, x),
                ...
                if (r || m(t)) {
                    ...
                    if (r && e.touchData.cxt) {
                        ...
                        if (r && (null == te || te.pannable()) && o.panningEnabled() && o.userPanningEnabled()) {
                            i(te, e.touchData.starts) && (t.preventDefault(), e.data.bgActivePosistion || (e.data.bgActivePosistion = nt(e.touchData.startPosition)), e.swipePanning ? (o.panBy({ x: g[0] * d, y: g[1] * d }), o.emit("dragpan")) : p && (e.swipePanning = !0, o.panBy({ x: S * d, y: B * d }), o.emit("dragpan"), te && (te.unactivate(), e.redrawHint("select", !0), e.touchData.start = null)));
                            h = e.projectIntoViewport(t.touches[0].clientX, t.touches[0].clientY);
                            s[0] = h[0], s[1] = h[1]
                        }
                    }
    ...
    return cl.use = function(e) { var t = Array.prototype.slice.call(arguments, 1); return t.unshift(cl), e.apply(null, t), this }, cl.warnings = function(e) { return ke(e) }, cl.version = "3.19.0", cl.stylesheet = cl.Stylesheet = ll, cl
}));